var $sidebar = null;
$(function() {
  $sidebar = $('#clockContainer');
  if($sidebar.length) {
    var w = $sidebar.width() - ($sidebar.width() * (20 / 100));
    $('<canvas id="orologio" style="margin-left:' + ($sidebar.width() * (10 / 100)) + 'px;width:' + w + 'px" width="' + w + '" height="' + w + '"></canvas>').appendTo($sidebar);
  }
});
